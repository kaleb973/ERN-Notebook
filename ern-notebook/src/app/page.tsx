...
export default function WorkspacePage() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-950 text-slate-50 font-sans select-none">
      ...
      <aside className={`${isLeftSidebarCollapsed ? 'w-25' : 'w-[260px]'} h-full bg-slate-900 border-r border-slate-800 flex flex-col p-4 transition-all duration-800 ease-out`}>
        <div className="flex items-center justify-between gap-2 px-2 pb-4 border-b border-slate-800">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {!isLeftSidebarCollapsed && <span className="font-semibold tracking-wide text-slate-200 truncate">ERN Workspace</span>}
          </div>
          <button
            type="button"
      ...
      <section className={`${isRightSidebarCollapsed ? 'w-17' : 'w-[300px]'} h-full bg-slate-900 border-l border-slate-800 flex flex-col p-4 transition-all duration-800 ease-out`}>
        <div className="flex items-center justify-between gap-2 px-2 pb-4 border-b border-slate-800">
