  ...
  return (
    <PasswordGate>
      <div className="flex h-screen w-screen overflow-hidden bg-slate-950 text-slate-50 font-sans select-none">
        ...
        {/* 1. Left Sidebar Panel (260px width) */}
        ...
        {/* 2. Center Lab Journal Canvas (Flex-1 expands to fill space) */}
        <main className="flex-1 h-full flex flex-col bg-slate-950 overflow-y-auto px-8 py-12">
          <div className="w-full max-w-3xl mx-auto space-y-6">
            ...
            <div className="min-h-[400px] text-slate-400 text-lg leading-relaxed">
              [Inline Editor Canvas Loading... Type here soon.]
            </div>
          </div>
        </main>

        {/* 3. Right Scientific Metadata Drawer (300px width) */}
