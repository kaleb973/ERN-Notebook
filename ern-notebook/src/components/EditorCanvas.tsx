      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 bg-slate-50 dark:bg-slate-900/40 p-3 rounded-lg border border-slate-200/60 dark:border-slate-800/60 text-xs">
          ...
          <div>
            ...
            {/* Renders a text input field only when a valid custom status string is active */}
            {currentNote?.metadata?.status &&
        ...
        {/* Rich Text Tiptap Viewport */}
        <div className="min-h-[400px]">
          <EditorContent editor={editor} />
        </div>

        {/* Scientific Execution Tray */}
        <div className="flex items-center justify-between border-t border-slate-200/60 dark:border-slate-800/60 pt-3 mt-4">
